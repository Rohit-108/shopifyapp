      ...
      <Layout>
        <Layout.Section oneHalf>
          <LegacyCard title="Total Orders" sectioned>
            <Chart chartData={data} line  options={{responsive: true, maintainAspectRatio:false}}/>
          </LegacyCard>
        </Layout.Section>
        <Layout.Section oneThird>
          <LegacyCard title="Completed" sectioned>
            <Chart chartData={data} doughnut options={{responsive: true, maintainAspectRatio:false}} />
          </LegacyCard>
        </Layout.Section>
        <Layout.Section oneThird>
          <LegacyCard title="Remaining" sectioned>
            <Chart chartData={data} bar options={{responsive: true, maintainAspectRatio:false}} />
          </LegacyCard>
        </Layout.Section>
      </Layout>
    </>
